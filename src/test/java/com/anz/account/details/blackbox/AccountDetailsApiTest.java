...
public class AccountDetailsApiTest {
	...
	public static final String X_CORRELATION_ID = "X_CORRELATION_ID";
	  ...
	  void getAccountDetails_returnAllAccountDetails() {
	    given()
	        .log().all()
	        .header(X_CORRELATION_ID, "Test_OK_1234")
	        .when()
	        .get("v1/accounts/getAccountList")
	        .then()
	        .log().all()
	        .statusCode(HttpStatus.SC_OK)
	        .body(containsString("347786244"));
	  }
	  ...
	  void getAccountTransactions_returnTransactionByAccountNo() {
	    given()
	        .log().all()
	        .header(X_CORRELATION_ID, "Test_OK_1010")
	        .when().body(new AccountTransactionRequest().builder().accountNumber("791066619"))
	        .post("v1/accounts/getAccountTransactionByAccountId")
	  ...
	  void getAccountTransactions_returnTransactionByAccountNo_NoAccountFound() {
	    given()
	        .log().all()
	        .header(X_CORRELATION_ID, "Test_OK_4321")
	        .when().body(new AccountTransactionRequest().builder().accountNumber("25133"))
	        .post("v1/accounts/getAccountTransactionByAccountId")
	        .then()
	        .log().all()
